...
module ECE423_QSYS_lpddr2 (
		...
		output wire [127:0] avl_rdata_1,                //                   .readdata
		input  wire [127:0] avl_wdata_1,                //                   .writedata
		input  wire [15:0]  avl_be_1,                   //                   .byteenable
	...
	altera_mem_if_hard_memory_controller_top_cyclonev #(
		...
		.LSB_RFIFO_PORT_1                        (1),
		.MSB_RFIFO_PORT_1                        (1),
		.AVL_DATA_WIDTH_PORT_2                   (128),
		.AVL_ADDR_WIDTH_PORT_2                   (25),
		.AVL_NUM_SYMBOLS_PORT_2                  (16),
		.LSB_WFIFO_PORT_2                        (2),
		.MSB_WFIFO_PORT_2                        (3),
		.LSB_RFIFO_PORT_2                        (2),
		.MSB_RFIFO_PORT_2                        (3),
		...
		.ENUM_RCFG_USER_PRIORITY_0               ("PRIORITY_2"),
		.ENUM_RCFG_USER_PRIORITY_1               ("PRIORITY_1"),
		.ENUM_RCFG_USER_PRIORITY_2               ("PRIORITY_3"),
		...
		.ENUM_RFIFO3_CPORT_MAP                   ("CMD_PORT_2"),
		...
		.ENUM_USER_PRIORITY_0                    ("PRIORITY_2"),
		.ENUM_USER_PRIORITY_1                    ("PRIORITY_1"),
		.ENUM_USER_PRIORITY_2                    ("PRIORITY_3"),
		...
		.mp_cmd_clk_3            (mp_cmd_clk_1_clk),                   //       mp_cmd_clk_3.clk
		.mp_cmd_reset_n_3        (mp_cmd_reset_n_1_reset_n),           //   mp_cmd_reset_n_3.reset_n
