...
`timescale 1 ps / 1 ps
module ECE423_QSYS_write_dma (
		output wire [28:0]   mm_write_address,             //         mm_write.address
		output wire          mm_write_write,               //                 .write
		output wire [127:0]  mm_write_byteenable,          //                 .byteenable
		output wire [1023:0] mm_write_writedata,           //                 .writedata
		input  wire          mm_write_waitrequest,         //                 .waitrequest
		output wire [2:0]    mm_write_burstcount,          //                 .burstcount
		...
		input  wire [1023:0] st_sink_data,                 //          st_sink.data
	...
	write_master #(
		...
		.ERROR_ENABLE                   (0),
		.ERROR_WIDTH                    (8),
		.BYTE_ENABLE_WIDTH              (128),
		.BYTE_ENABLE_WIDTH_LOG2         (7),
		.ADDRESS_WIDTH                  (29),
		.FIFO_DEPTH_LOG2                (4),
		.SYMBOL_WIDTH                   (8),
		.NUMBER_OF_SYMBOLS              (128),
		.NUMBER_OF_SYMBOLS_LOG2         (7),
		...
		.snk_empty          (7'b0000000),                                     //       (terminated)
