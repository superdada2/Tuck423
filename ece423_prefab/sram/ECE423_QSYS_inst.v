	ECE423_QSYS u0 (
		...
		.cpu_2_reset_cpu_resetrequest                 (<connected-to-cpu_2_reset_cpu_resetrequest>),                 //        cpu_2_reset.cpu_resetrequest
		.cpu_2_reset_cpu_resettaken                   (<connected-to-cpu_2_reset_cpu_resettaken>),                   //                   .cpu_resettaken
		...
		.sram_memory_memory_tcm_chipselect_n_out      (<connected-to-sram_memory_memory_tcm_chipselect_n_out>),      //        sram_memory.memory_tcm_chipselect_n_out
		.sram_memory_memory_tcm_byteenable_n_out      (<connected-to-sram_memory_memory_tcm_byteenable_n_out>),      //                   .memory_tcm_byteenable_n_out
		.sram_memory_memory_tcm_address_out           (<connected-to-sram_memory_memory_tcm_address_out>),           //                   .memory_tcm_address_out
		.sram_memory_memory_tcm_data_out              (<connected-to-sram_memory_memory_tcm_data_out>),              //                   .memory_tcm_data_out
		.sram_memory_memory_tcm_write_n_out           (<connected-to-sram_memory_memory_tcm_write_n_out>),           //                   .memory_tcm_write_n_out
		.sram_memory_memory_tcm_outputenable_n_out    (<connected-to-sram_memory_memory_tcm_outputenable_n_out>),    //                   .memory_tcm_outputenable_n_out
